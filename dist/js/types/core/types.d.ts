...
export type FormatterFunction = (cell: CellComponentType, formatterParams: Record<string, any>, onRendered: (callback: () => void) => void) => string | HTMLElement;
/** Fonction de tri personnalisé */
export type SorterFunction = (a: any, b: any, aRow: RowComponentType, bRow: RowComponentType, column: ColumnComponentType, dir: SortDirection, sorterParams: Record<string, any>) => number;
/** Fonction d'édition personnalisée */
export type EditorFunction = (cell: CellComponentType, onRendered: (callback: () => void) => void, success: (value: any) => void, cancel: () => void, editorParams: Record<string, any>) => HTMLElement | false;
/** Fonction de validation */
export type ValidatorFunction = (cell: CellComponentType, value: any, parameters: any) => boolean;
/** Fonction d'accession aux données */
export type AccessorFunction = (value: any, data: any, type: 'data' | 'download' | 'clipboard' | 'print' | 'htmlOutput', accessorParams: any, column: ColumnComponentType, row: RowComponentType) => any;
/** Fonction de mutation de données */
export type MutatorFunction = (value: any, data: any, type: 'data' | 'edit' | 'clipboard' | 'import', mutatorParams: any, column: ColumnComponentType) => any;
/** Fonction de filtrage */
export type FilterFunction = (filterVal: any, rowVal: any, rowData: any, filterParams: any) => boolean;
/** Définition d'un tri */
...
export interface ColumnDefinition {
    ...
    validator?: string | ValidatorFunction | Array<string | ValidatorFunction | {
        type: string;
        parameters?: any;
    }>;
...
export interface TabulatorOptions extends TabulatorEvents {
    ...
    history?: boolean;
    tooltipDelay?: number;
    tooltipGenerationMode?: 'hover' | 'click';
