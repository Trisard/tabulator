...
export default class Format extends Module {
	...
	static moduleName: string = "format";
	
	//load defaults
	static formatters: Record<string, FormatterFunction> = defaultFormatters;
	...
	lookupTypeFormatter(column: any, type: string): any {
		var config: any = {params:column.definition["formatter" + type + "Params"] || {}},
