...
export default class Menu extends Module {
	...
	initializeColumnHeaderMenu(column: any){
	...
	loadMenuTableCellEvent(option: string, e: any, cell: any){
		if(cell._cell){
			cell = cell._cell;
		}
	...
	loadMenuTableColumnEvent(option: string, e: any, column: any){
		if(column._column){
	...
	loadMenuEvent(menu: any, e: any, component: any){
		if(component._group){
	...
	loadMenu(e: any, component: any, menu: any, parentEl?: HTMLElement, parentPopup?: any){
