...
export default class Sort extends Module {
	...
	static moduleName: string = "sort";

	//load defaults
	static sorters: Record<string, SorterFunction> = defaultSorters;
	...
	initializeColumn(column: any): void {
		...
		if(column.definition.headerSort !== false){
			...
			switch(typeof this.table.options.headerSortElement){
				...
				case "object":
					arrowEl.appendChild(this.table.options.headerSortElement as Node);
					break;
				
				default:
					arrowEl.innerHTML = this.table.options.headerSortElement as string;
			}
	...
	setSort(sortList: any, dir?: string): void {
		...
		sortList.forEach(function(item: any){
			var column;
	...
	clearColumnHeaders(): void {
		this.table.columnManager.getRealColumns().forEach((column: any) => {
			if(column.modules.sort){
	...
	setColumnHeaderSortIcon(column: any, dir: string): void {
		...
		if(column.definition.headerSort && typeof this.table.options.headerSortElement === "function"){
			...
			arrowEl = (this.table.options.headerSortElement as (...args: any[]) => any).call(this.table, column.getComponent(), dir);
