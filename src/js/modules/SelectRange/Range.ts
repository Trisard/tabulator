...
export default class Range extends CoreFeature{
	...
	initialized: boolean;
	initializing: { start: boolean; end: boolean };
	destroyed: boolean;
	top: number;
	bottom: number;
	left: number;
	...
	layout(): void {
		...
		_vDomLeft = (this.table.columnManager.renderer as any).leftCol,
		_vDomRight = (this.table.columnManager.renderer as any).rightCol,		
