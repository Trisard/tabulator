...
export default class Spreadsheet extends Module{
	...
	static moduleName: string = "spreadsheet";
	...
	initializeTabset(): void {
		...
		var altContainer: any = this.options("spreadsheetSheetTabsElement");
	...
	tableInitialized(): void {
		if(this.sheets.length){
			...
			if(this.options("spreadsheetSheets")){
				this.loadSheets(this.options("spreadsheetSheets") as any[]);
