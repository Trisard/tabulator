...
export default class DataLoader extends CoreFeature {
	...
	load(data: any, params?: Record<string, any>, config?: any, replace?: boolean, silent?: boolean, columnsChanged?: boolean): Promise<void> {
		...
		if (this.confirm("data-loading", [data, params, config, silent])) {
			...
			params = this.mapParams(params as Record<string, any>, this.table.options.dataSendParams || {});

			var result: Promise<any[]> = this.chain("data-load", [data, params, config, silent], false, Promise.resolve([]));
	...
	alertLoader(): void {
		var shouldLoad = typeof this.table.options.dataLoader === "function" ? (this.table.options.dataLoader as any)() : this.table.options.dataLoader;
