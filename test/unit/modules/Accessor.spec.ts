...
import Accessor from '../../../src/js/modules/Accessor/Accessor';
import { ColumnDefinition } from '../../../src/js/core/types';
...
describe('Accessor', function(){
	...
	let tableColumns: ColumnDefinition[] = [
		{title:"ID", field:"id"},
		{title:"Name", field:"name", accessor:function(value: any){ return value; }},
		{title:"Age", field:"age", accessor:function(value: any, data: any, type: any){
			return value + " years";
		}},
		{title:"Custom", field:"custom", accessorDownload:function(value: any){ return value; }}
	];

	// Mock accessor function
	beforeAll(function(){
		// Add a test accessor to the static accessors
		(Accessor as any).accessors.test = function(value: any) { return value + "-test"; };
	});
	...
	test('lookupAccessor returns function directly', function(){
		const customFunc = function(value: any){ return value; };
			...
			modules: {
				accessor: {
					accessor: {
						...
						accessor: function(value: any) { return value + " years"; },
						params: {}
					}
				}
			},
			getFieldValue: function(data: any) { return data.age; },
			setFieldValue: function(data: any, value: any) { data.age = value; },
		...
		const mockColumn: any = {
			...
			modules: {
				accessor: {
					...
					accessorDownload: {
						accessor: function(value: any) { return "downloaded-" + value; },
						params: {}
					}
				}
			},
			getFieldValue: function(data: any) { return data.custom || ""; },
			setFieldValue: function(data: any, value: any) { data.custom = value; },
			getComponent: function() { return {}; }
		};
